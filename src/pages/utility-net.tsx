                        ...
                        <FeatureCard>
                            <FeatureCard.Body>
                                <FeatureCard.Grid>
                                    ...
                                    <FeatureCard.Image>
                                        <img className="w-full h-[200px] object-cover pointer-events-none rounded-lg" src="./assets/images/infrastructural-planning.png" alt="infrastructural-planning" />
                                    </FeatureCard.Image>
                                </FeatureCard.Grid>
                                <FeatureCard.Divider />
                            </FeatureCard.Body>
                        ...
                        <FeatureCard>
                            <FeatureCard.Body>
                                <FeatureCard.Grid>
                                    ...
                                    <FeatureCard.Image>
                                        <img className="w-full h-[200px] object-cover pointer-events-none rounded-lg" src="./assets/images/outage-response-optimization.png" alt="outage-response-optimization" />
                                    </FeatureCard.Image>
                                </FeatureCard.Grid>
                                <FeatureCard.Divider />
                            </FeatureCard.Body>
                            ...
                            <FeatureCard.Body>
                                <FeatureCard.Grid>
                                    ...
                                    <FeatureCard.Image className="md:col-span-5">
                                        <img className="w-full h-[200px] object-cover pointer-events-none rounded-lg" src="./assets/images/utility-net-use-cases.png" alt="utility-net-use-cases" />
                                    </FeatureCard.Image>
                                </FeatureCard.Grid>
                            </FeatureCard.Body>
                        </FeatureCard>
                                    ...
                                    <Pricing.GridCard>
                                        ...
                                        <Pricing.GridCardList>
                                            ...
                                            <Pricing.GridCardListItem>
                                                ...
                                                <span className="text-sm text-neutral-70 font-normal ">Email support only.</span>
                                            </Pricing.GridCardListItem>
