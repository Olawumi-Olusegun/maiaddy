                            ...
                            <div className="flex flex-col gap-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-b pb-5">
                                    <div className="flex flex-col gap-4 rounded-lg w-full ">
                                        <h3 className="text-xl font-bold text-gray-800 mb-2">Localized Soil and Climate Data</h3>
                                        <p className="text-gray-600 text-xl">Access detailed soil composition, moisture levels, and climate conditions for specific postcode areas, enabling more accurate planting and harvesting decisions.</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-b pb-5">
                                    <div className="flex flex-col gap-4 rounded-lg w-full ">
                                        <h3 className="text-xl font-bold text-gray-800 mb-2">Pest and Disease Monitoring</h3>
                                        <p className="text-gray-600 text-xl">Stay ahead of potential threats by monitoring and predicting the spread of pests and diseases within localized areas, allowing for targeted interventions.</p>
                                    </div>
                                    <div className="w-full lg:max-w-[371px]">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-b pb-5">
                                    <div className="flex flex-col gap-4 rounded-lg w-full ">
                                        <h3 className="text-xl font-bold text-gray-800 mb-2">Yield Prediction Models</h3>
                                        <p className="text-gray-600 text-xl">Utilize historical data and real-time environmental inputs to forecast crop yields, helping you plan for market demands and optimize resource allocation.</p>
                                    </div>
                                    <div className="w-full lg:max-w-[371px]">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-b pb-5">
                                    <div className="flex flex-col gap-4 rounded-lg w-full ">
                                        <h3 className="text-xl font-bold text-gray-800 mb-2">Supply Chain Optimization</h3>
                                        <p className="text-gray-600 text-xl">Streamline logistics by identifying the most efficient routes and distribution hubs, reducing transportation costs and ensuring timely delivery of fresh produce.</p>
                                    </div>
                                    <div className="w-full lg:max-w-[371px]">
                                        <img className="w-full h-[200px] object-cover pointer-events-none rounded-lg" src="./assets/images/billboard.png" alt="billboard" />
                                    </div>
                        ...
                        <div className="w-full flex flex-col gap-4 ">
                                ...
                                <div className="flex flex-col gap-4 rounded-lg w-full col-span-12 md:col-span-7">
                                    <div className="w-full ">
                                        <div className="flex items-start flex-wrap gap-3">
                                            <h1 className="font-semibold w-full text-xl">Precision Farming for Smallholder Farmers</h1>
                            ...
                            <div className="grid grid-cols-12 gap-5 lg:gap-x-10 py-5">
                                <div className="flex flex-col gap-4 rounded-lg w-full col-span-12 md:col-span-7">
                                    <div className="w-full ">
                                        <div className="flex items-start flex-wrap gap-3">
                                            <h1 className="font-semibold w-full text-xl">Pest and Disease Monitoring</h1>
                            ...
                            <div className="grid grid-cols-12 gap-5 lg:gap-x-10 py-5">
                                <div className="flex flex-col gap-4 rounded-lg w-full col-span-12 md:col-span-7">
                                    <div className="w-full ">
                                        <div className="flex items-start flex-wrap gap-3">
                                            <h1 className="font-semibold w-full text-xl">Optimized Agricultural Supply Chain</h1>
                                            <p className="w-full md:max-w-[700px] text-xl"> <span className="font-semibold">Scenario:</span> A large agribusiness needs to optimize its logistics operations to reduce costs and ensure timely delivery of perishable goods.</p>
