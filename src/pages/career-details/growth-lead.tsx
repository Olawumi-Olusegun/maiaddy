        ...
        <section className="w-full">
            <Container>
                ...
                <div className="w-full max-w-[720px] mx-auto flex flex-col gap-8 my-10 ">
                    ...
                    <div className="w-full">
                        <h2 className="mb-4 text-primary-90 text-2xl lg:text-2xl font-bold">Key Responsibilities</h2>
                    ...
                    <div className="w-full">
                        <h2 className="mb-4 text-primary-90 text-2xl lg:text-2xl font-bold">Sales</h2>
                        <ul className="list-disc space-y-3 text-neutral-70 text-xl">
                    ...
                    <div className="w-full">
                        <h2 className="mb-4 text-primary-90 text-2xl lg:text-2xl font-bold">Business Development</h2>
                        <ul className="list-disc space-y-3 text-neutral-70 text-xl">
